...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.routerObj = this.router.events.subscribe((event) => {
      if (event instanceof NavigationEnd) {
        ...
        const role = ['admin', 'teacher', 'student', 'tutor'];
  ...
  ngOnInit() {
    if (this.userStorageService.usuarioActual) {
      const userRole = this.userStorageService.usuarioActual.nombreRol;
      this.userFullName = this.userStorageService.usuarioActual.nombre;
      ...
      if (userRole === Role.Tesoreria) {
        this.userType = Role.Tesoreria;
      }
